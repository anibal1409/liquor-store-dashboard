...
const APIS = [AuthService, CategoriesService, CustomersService, DefaultService, OrdersService, ProductsService, SaleService, StatisticsService, UsersService];
...
export { APIS, ApiModule, AuthService, BASE_PATH, COLLECTION_FORMATS, CategoriesService, Configuration, CustomersService, DefaultService, OrdersService, ProductsService, SaleService, StatisticsService, UsersService };
